...
async function main() {
    ...
    // 2. FUNCIÓN MAESTRA DE GENERACIÓN (La que hace el trabajo real)
...
====================================================`;
    ...
    // 3. INTENTO DE CONEXIÓN BLOCKCHAIN (Segundo plano)
    try {
    ...
    // 4. EL "BOTÓN DE PÁNICO" (Pulsa ENTER para forzar el reporte)
    console.log("----------------------------------------------------");
