...
proxy asset is not an ecmascript moduleEcmascriptModuleAsset must implement EcmascriptChunkItemchunking context must impl EcmascriptChunkingContext to use EcmascriptClientReferenceProxyModulepackages/next-swc/crates/next-core/src/next_client_reference/ecmascript_client_reference/ecmascript_client_reference_transition.rsnext/dist/esm/next/dist/client asset is not ecmascript chunk placeableSSR asset is not ecmascript chunk placeablepackages/next-swc/crates/next-core/src/next_client_reference/visit_client_reference.rspackages/next-swc/crates/next-core/src/next_config.rs/_next/Loading Next.js configentry/config/next.jsnext_configEvaluation of Next.js config failedexperimental.turbo.loadersexperimental.turbo.rulesThe new option is similar, but the key should be a glob instead of an extension.
...
globalThis.__RSC_MANIFEST[client reference chunks not foundpackages/next-swc/crates/next-core/src/next_pages/page_entry.rspages-api.jspages-edge-api.jsVAR_MODULE_DOCUMENT@vercel/turbopack-next/pages/_documentVAR_MODULE_APP@vercel/turbopack-next/pages/_appInvalid path typeexport const register = hoist(userland, "register")
packages/next-swc/crates/next-core/src/next_route_matcher/mod.rspackages/next-swc/crates/next-core/src/next_server/context.rsdist/lib/server-external-packages.jsonpackages/next-swc/crates/next-core/src/next_server/resolve.rs**/node_modules/{,packages/next-swc/crates/next-core/src/next_server/route_transition.rspackages/next-swc/crates/next-core/src/next_server_component/server_component_module.rschunking context must impl EcmascriptChunkingContext to use NextServerComponentModule),
});
...
packages/next-swc/crates/next-core/src/pages_structure.rsentry/pages/_app.tsxentry/pages/_document.tsxentry/pages/_error.tsxpackages/next-swc/crates/next-core/src/sass.rssass_options must be an object*.module.scss*.module.sass*.scss*.sassnext/dist/compiled/sass-loadercompilerOptionsuseDefineForClassFieldsexperimentalDecoratorsemitDecoratorMetadatajsxImportSourceserver_path () is not in server_root ()The exported config object must contain an variable initializer.Expected file content for file